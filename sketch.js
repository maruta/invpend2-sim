...
function dVdt(x) {
    ...
    dVxdt = -(dth1*2.178164076428267E-1+dth2*3.399084634881735E-1+dz*3.812820205527619E-1+th1*4.639435664626901E-2+th2*1.827593419238315+z*3.943856994488532E-1)*(dth1*g*(-2.535012907873332)+dth2*g*2.379305053506306E1+dz*g*7.810892835891162-g*th1*1.245144929728302E2+g*th2*1.664657282958085E2+g*z*5.773502691896171+((dth2*dth2)*l1*(l2*l2*l2)*(m2*m2)*sin(th1-th2)*2.0-g*l1*(l2*l2)*(m2*m2)*sin(th1)*4.0-J2*g*l1*m1*sin(th1)*8.0-J2*g*l1*m2*sin(th1)*1.6E1+(dth1*dth1)*(l1*l1)*(l2*l2)*(m2*m2)*cos(th1-th2)*sin(th1-th2)*4.0+g*l1*(l2*l2)*(m2*m2)*cos(th1-th2)*sin(th2)*4.0-g*l1*(l2*l2)*m1*m2*sin(th1)*2.0+J2*(dth2*dth2)*l1*l2*m2*sin(th1-th2)*8.0)/(J1*J2*1.6E1+(l1*l1)*(l2*l2)*(m2*m2)*4.0+J2*(l1*l1)*m1*4.0+J1*(l2*l2)*m2*4.0+J2*(l1*l1)*m2*1.6E1-(l1*l1)*(l2*l2)*(m2*m2)*pow(cos(th1-th2),2.0)*4.0+(l1*l1)*(l2*l2)*m1*m2))-(dth1*1.827593419238315+dth2*8.441638806461018+dz*4.838637263239541-th1*2.483344021304082E1+th2*5.356611299640473E1+z*4.121077239378319)*(-dth2-dth1*g*2.535012907873332+dth2*g*2.379305053506306E1+dz*g*7.810892835891162-g*th1*1.245144929728302E2+g*th2*1.664657282958085E2+g*z*5.773502691896171)-(dth1*3.399084634881735E-1+dth2*1.356479074543226+dz*8.374408097330027E-1-th1*3.637064125960309+th2*8.441638806461018+z*7.367117758101513E-1)*(dth1*g*(-2.535012907873332)+dth2*g*2.379305053506306E1+dz*g*7.810892835891162-g*th1*1.245144929728302E2+g*th2*1.664657282958085E2+g*z*5.773502691896171-((dth1*dth1)*(l1*l1*l1)*l2*(m2*m2)*sin(th1-th2)*8.0+g*(l1*l1)*l2*(m2*m2)*sin(th2)*8.0+J1*g*l2*m2*sin(th2)*8.0+(dth1*dth1)*(l1*l1*l1)*l2*m1*m2*sin(th1-th2)*2.0+(dth2*dth2)*(l1*l1)*(l2*l2)*(m2*m2)*cos(th1-th2)*sin(th1-th2)*4.0-g*(l1*l1)*l2*(m2*m2)*cos(th1-th2)*sin(th1)*8.0+g*(l1*l1)*l2*m1*m2*sin(th2)*2.0+J1*(dth1*dth1)*l1*l2*m2*sin(th1-th2)*8.0-g*(l1*l1)*l2*m1*m2*cos(th1-th2)*sin(th1)*4.0)/(J1*J2*1.6E1+(l1*l1)*(l2*l2)*(m2*m2)*4.0+J2*(l1*l1)*m1*4.0+J1*(l2*l2)*m2*4.0+J2*(l1*l1)*m2*1.6E1-(l1*l1)*(l2*l2)*(m2*m2)*pow(cos(th1-th2),2.0)*4.0+(l1*l1)*(l2*l2)*m1*m2))-(dth1*3.943856994488532E-1+dth2*7.367117758101513E-1+dz*9.146507034066623E-1-th1*4.390771154279364E-1+th2*4.121077239378319+z*1.352886324423944)*(-dz-dth1*g*2.535012907873332+dth2*g*2.379305053506306E1+dz*g*7.810892835891162-g*th1*1.245144929728302E2+g*th2*1.664657282958085E2+g*z*5.773502691896171)+(dth1*-4.639435664626901E-2+dth2*3.637064125960309+dz*9.884071242788216E-1-th1*1.716117492535966E1+th2*2.483344021304082E1+z*4.390771154279364E-1)*(-dth1-dth1*g*2.535012907873332+dth2*g*2.379305053506306E1+dz*g*7.810892835891162-g*th1*1.245144929728302E2+g*th2*1.664657282958085E2+g*z*5.773502691896171)-(dth1*3.812820205527619E-1+dth2*8.374408097330027E-1+dz*8.617041299013249E-1-th1*9.884071242788216E-1+th2*4.838637263239541+z*9.146507034066623E-1)*(dth1*g*(-2.535012907873332)+dth2*g*2.379305053506306E1+dz*g*7.810892835891162-g*th1*1.245144929728302E2+g*th2*1.664657282958085E2+g*z*5.773502691896171);
